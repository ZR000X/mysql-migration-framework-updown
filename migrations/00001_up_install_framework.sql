...
-- Dumping database structure for BMS-DDE-DEV
CREATE DATABASE IF NOT EXISTS `BMS-DDE-DEV` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `BMS-DDE-DEV`;

-- Dumping structure for procedure BMS-DDE-DEV.dbi_authorise
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbi_call
DELIMITER //
...
-- Dumping structure for table BMS-DDE-DEV.dbi_calls
...
-- Dumping data for table BMS-DDE-DEV.dbi_calls: ~0 rows (approximately)

-- Dumping structure for procedure BMS-DDE-DEV.dbi_fn_get_entry
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbi_fn_update_entry
DELIMITER //
...
-- Dumping structure for table BMS-DDE-DEV.dbi_functionality
...
-- Dumping data for table BMS-DDE-DEV.dbi_functionality: ~2 rows (approximately)
...
-- Dumping structure for procedure BMS-DDE-DEV.dbi_response_append_to_callstack
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbi_response_initiate
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbi_response_set_body_field
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbi_response_set_err_msg
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbi_response_set_status
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbi_response_set_testmode_field
DELIMITER //
...
-- Dumping structure for table BMS-DDE-DEV.dbi_statuses
...
-- Dumping data for table BMS-DDE-DEV.dbi_statuses: ~63 rows (approximately)
...
-- Dumping structure for procedure BMS-DDE-DEV.dbut_mock_dbi_call
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbut_run
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbut_run_tests
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbut_seed_database
DELIMITER //
...
-- Dumping structure for table BMS-DDE-DEV.dbut_seed_tables
...
-- Dumping data for table BMS-DDE-DEV.dbut_tests: ~0 rows (approximately)

-- Dumping structure for procedure BMS-DDE-DEV.dbut_test_functionality
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.dbut_truncate_before_template
DELIMITER //
...
-- Dumping structure for table BMS-DDE-DEV.dbut_unit_tests
...
-- Dumping data for table BMS-DDE-DEV.dbut_unit_tests: ~0 rows (approximately)

-- Dumping structure for table BMS-DDE-DEV.dbut_unit_test_cases
...
-- Dumping data for table BMS-DDE-DEV.dbut_unit_test_cases: ~3 rows (approximately)
...
-- Dumping structure for function BMS-DDE-DEV.fn_clean_string
DELIMITER //
...
-- Dumping structure for function BMS-DDE-DEV.fn_compare_json_paths
DELIMITER //
...
-- Dumping structure for function BMS-DDE-DEV.fn_dbi_get_functionality_proc_name
DELIMITER //
...
-- Dumping structure for function BMS-DDE-DEV.fn_dbi_get_functionality_sql
DELIMITER //
...
-- Dumping structure for function BMS-DDE-DEV.fn_dbi_get_response
DELIMITER //
...
-- Dumping structure for function BMS-DDE-DEV.fn_dbi_response_get_err_msg
DELIMITER //
...
-- Dumping structure for function BMS-DDE-DEV.fn_dbi_response_get_status
DELIMITER //
...
-- Dumping structure for function BMS-DDE-DEV.fn_dbut_compare_responses
DELIMITER //
...
-- Dumping structure for function BMS-DDE-DEV.fn_force_json_array
DELIMITER //
...
-- Dumping structure for function BMS-DDE-DEV.fn_ms_since_then
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.mod_execute_queries
DELIMITER //
...
-- Dumping structure for procedure BMS-DDE-DEV.mod_execute_query
DELIMITER //
...
-- Dumping structure for table BMS-DDE-DEV.trans_accounts
...
-- Dumping data for table BMS-DDE-DEV.trans_accounts: ~2 rows (approximately)
INSERT INTO `trans_accounts` (`account_id`, `account_name`, `user_id`) VALUES
	(1, 'Account 1', '1'),
	(2, 'Account 2 ', '1');

-- Dumping structure for table BMS-DDE-DEV.trans_entries
...
-- Dumping data for table BMS-DDE-DEV.trans_entries: ~1 rows (approximately)
...
-- Dumping structure for table BMS-DDE-DEV._seed_trans_accounts
...
-- Dumping data for table BMS-DDE-DEV._seed_trans_accounts: ~2 rows (approximately)
INSERT INTO `_seed_trans_accounts` (`account_id`, `account_name`, `user_id`) VALUES
	(1, 'Account 1', '1'),
	(2, 'Account 2 ', '1');

-- Dumping structure for table BMS-DDE-DEV._seed_trans_entries
...
-- Dumping data for table BMS-DDE-DEV._seed_trans_entries: ~1 rows (approximately)
...
-- Dumping structure for procedure BMS-DDE-DEV._view_dbf_functions
DELIMITER //
